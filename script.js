...
function showNotification(message, type = 'info') {
    ...
    switch (type) {
        ...
        case 'error':
            ...
            break;
        default:
            notification.style.background = 'linear-gradient(135deg, #00ffff, #0088cc)';
    }
...
function showAllBlogs() {
    showNotification('Blog archive feature coming soon!', 'info');
}
...
console.log(`
🚀 Welcome to the Futuristic Portfolio!
✨ Built with modern web technologies
🎨 Featuring amazing animations and effects
📱 Fully responsive design
🔧 Interactive and engaging user experience

Developed with ❤️ for the future of web development
`);

// Export functions for global access
window.scrollToSection = scrollToSection;
window.showAllBlogs = showAllBlogs;
